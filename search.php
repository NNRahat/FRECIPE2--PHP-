...
<body class="colorset">
  ...
  <main class="colorset">
    ...
    <section class="gap my-5 non-veges">
      <?php 
      $aid=$_GET['editsearch']; 
      $query_searh =mysqli_query($con, "SELECT * FROM recipes WHERE Cuisines LIKE '%$aid%' OR OCCASIONS LIKE '%$aid%' OR Meals LIKE '%$aid%' OR Dinner LIKE '%$aid%' OR Ingredients LIKE '%$aid%'");
